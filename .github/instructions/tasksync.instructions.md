...
- Monitor tasks.txt every 180 seconds (180000ms) using PowerShell: `Get-Content .github\tasks.txt | Measure-Object -Word`
...
- **MANDATORY**: Execute `Start-Sleep -Seconds 30; Get-Content .github\tasks.txt | Measure-Object -Word` every 30 seconds
...
- Primary check: `Get-Content .github\tasks.txt | Measure-Object -Word`
...
<timeout_management>
**Monitoring Protocol**:
- **State 1**: `Get-Content .github\tasks.txt | Measure-Object -Word` (every 180 seconds / 180000ms, no Start-Sleep)
- **State 2**: **MANDATORY SLEEP COMMAND** - `Start-Sleep -Seconds 30; Get-Content .github\tasks.txt | Measure-Object -Word` (every 30 seconds / 30000ms)
...
3. Execute first monitoring command: `Start-Sleep -Seconds 30; Get-Content .github\tasks.txt | Measure-Object -Word`
...
3. Monitor every 180 seconds (180000ms): `Get-Content .github\tasks.txt | Measure-Object -Word`
...
4. Execute: **MANDATORY SLEEP COMMAND** - `Start-Sleep -Seconds 30; Get-Content .github\tasks.txt | Measure-Object -Word` (every 30 seconds / 30000ms)
