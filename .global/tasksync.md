...
**IMPORTANT**: The `tasks.txt` file is located in the `.global/` folder (`.global/tasks.txt`). You must always check this specific location for new instructions and updates every 60000 ms (60 seconds) to 300000 ms (5 minutes)
